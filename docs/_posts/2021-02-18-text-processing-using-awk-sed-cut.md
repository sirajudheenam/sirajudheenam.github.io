...
```
ID=`awk '$4=="windows-2016" {print $2}' image_list.txt`
echo $ID
27a3-46c2-b821
```
...
ID=`awk -v image_name=$IMAGE_NAME '$4==image_name {print $2}' image_list.txt`
echo $ID
68c8-4d4b-a5b5
```
...
# create a file called image.awk
image.awk
{ 
id=$2;
name=$4;
...
awk '{ sum += $2 }; END { print "You scored ", sum, "out of 500 marks"}' marks.txt
